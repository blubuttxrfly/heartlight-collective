...
export function exchangeAgreementToRow(ag: ExchangeAgreement): Record<string, unknown> {
  return {
    ...
    requester_unreg_id: ag.requesterUnregId || null,
    is_requester_unregistered: ag.isRequesterUnregistered,
    requester_contact_email: ag.requesterContactEmail || null,
    requester_contact_phone: ag.requesterContactPhone || null,
    requester_preferred_contact: ag.requesterPreferredContact || null,
...
export function rowToExchangeAgreement(row: any): ExchangeAgreement {
  return {
    ...
    // Wave 10 — unregistered requester support
    requesterUnregId: row.requester_unreg_id || undefined,
    isRequesterUnregistered: Boolean(row.is_requester_unregistered),
    requesterContactEmail: row.requester_contact_email || undefined,
    requesterContactPhone: row.requester_contact_phone || undefined,
    requesterPreferredContact: row.requester_preferred_contact || undefined,
...
export function rowToVendor(row: any): VendorRecord {
  return {
    ...
    vendorType: (row.vendor_type as VendorRecord['vendorType']) || 'vendor_shop',
...
export function exchangeRequestToRow(r: ExchangeRequest): Record<string, unknown> {
  return {
    ...
    requester_name: r.requesterName,
    // Wave 10
    requester_unreg_id: r.requesterUnregId || null,
    is_requester_unregistered: r.isRequesterUnregistered ?? false,
    requester_contact_email: r.requesterContactEmail || null,
    requester_contact_phone: r.requesterContactPhone || null,
    requester_preferred_contact: r.requesterPreferredContact || null,
